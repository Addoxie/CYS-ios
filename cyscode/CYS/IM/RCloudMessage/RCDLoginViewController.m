...
- (void)viewDidLoad
{
    ...
    if (self.rcDebug) {//测试切换appkey使用
        NSDictionary *defaultValues = [NSDictionary dictionaryWithObjectsAndKeys:@[@"kj7swf8o70pf2", @"kj7swf8o70pf2", @"kj7swf8o70pf2"], @"keys", @[@1, @2, @0], @"envs", nil];
...
{
    token=@"ilyiUfIm+lNntF5PemGkgja0hwwBjnSX8RnhaIN48kBgqoky7rdhgyVSKMVV1DMegjBMBJs4s9YMzy4FaYSThdseA1efPdGE";
    //登陆融云服务器
