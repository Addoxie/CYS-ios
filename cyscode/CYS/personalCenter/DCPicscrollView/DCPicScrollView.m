...
- (void)preparePageControl {
    ...
    UIPageControl *page = [[UIPageControl alloc] initWithFrame:CGRectMake(self.frame.size.width/2.0-myWidth/2.0,myHeight - 17,myWidth, 7)];
    
    page.pageIndicatorTintColor = [UIColor whiteColor];
    page.currentPageIndicatorTintColor = KlightOrangeColor;
...
- (void)setStyle:(PageControlStyle)style {
    if (style == PageControlAtRight) {
        ...
        _PageControl.frame = CGRectMake(myWidth/2.0-w/2.0,  myHeight-17, w, 7);
       // _PageControl.center = CGPointMake(myWidth/2.0-w/2.0, myHeight-pageSize * 0.5);
    }
}
