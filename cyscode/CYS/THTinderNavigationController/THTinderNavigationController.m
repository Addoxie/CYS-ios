...
- (void)setCurrentPage:(NSInteger)currentPage animated:(BOOL)animated {
    ...
    [self.paggingScrollView setContentOffset:CGPointMake(currentPage * pageWidth,-64) animated:animated];
}
...
//    self.paggingNavbar.contentOffset=CGPointMake(0, 64);
//    self.paggingScrollView.contentOffset=CGPointMake(0, 64);
}
...
- (void)viewDidLoad {
    ...
    [self reloadData];
    // [self.paggingScrollView scrollRectToVisible:self.view.bounds animated:YES];
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    ...
    [self.delegate THTinderShowCurrentPageIndex:self.currentPage];
}
//-(void)viewWillAppear:(BOOL)animated{
//    [super viewWillAppear:animated];
//    self.paggingNavbar.contentOffset=CGPointMake(0, 0);
//}
@end
