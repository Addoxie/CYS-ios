...
- (void)slideMenuAtProgress:(CGFloat)progress {
   ...
   // currentItem.backgroundColor=[UIColor yellowColor];
    WMMenuItem *nextItem = (WMMenuItem *)[self viewWithTag:tag+1];
    //currentItem.backgroundColor=KGreenColor;
    if (rate == 0.0) {
        rate = 1.0;
        self.selItem.rate = 0;
        ...
        if (self.isneedhideItemBackground) {
            
        }else{
              self.selItem.backgroundColor=[UIColor clearColor];
            if (tag==6250) {
                currentItem.backgroundColor=KRedColor;
            } else if (tag==6251){
                currentItem.backgroundColor=KlightOrangeColor;
            } else if (tag==6252){
                currentItem.backgroundColor=KGreenColor;
            }
        }
    ...
    for (int i = 0; i < self.items.count; i++) {
        ...
        if (i == 0) {
            ...
            if (self.isneedhideItemBackground) {
             ...
             item.backgroundColor=KRedColor;
            }
...
- (void)didPressedMenuItem:(WMMenuItem *)menuItem {
   ...
   // menuItem.backgroundColor=KGreenColor;
    NSLog(@"%zd",menuItem.tag);
    
    if (self.isneedhideItemBackground) {
        
    }else{
          self.selItem.backgroundColor=[UIColor clearColor];
        if (menuItem.tag==6250) {
            menuItem.backgroundColor=KRedColor;
        } else if (menuItem.tag==6251){
            menuItem.backgroundColor=KlightOrangeColor;
        } else if (menuItem.tag==6252){
            menuItem.backgroundColor=KGreenColor;
        }
    }
