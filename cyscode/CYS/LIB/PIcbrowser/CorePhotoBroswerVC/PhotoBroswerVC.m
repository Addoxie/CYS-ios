...
-(void)showWithPage:(NSUInteger)page{
    ...
    //NSLog(@"%zd",page);
//    if (photoItemView.photoModel.havefeeback==NO) {
//        NSMutableDictionary *postdic=[[NSMutableDictionary alloc]initWithObjectsAndKeys:photoItemView.photoModel.feebackpostid,@"post-id",photoItemView.photoModel.feebackimageid,@"image-id", nil];
//        
//        [[PublicTools shareInstance]PostNetWorkJSONWithURLStr:@"private/post/image/view" whitdic:postdic theReturnBlock:^(id respondataarr) {
//            //        if (respondata==nil) {
...
//                
//                NSLog(@"feedback OK");
//                photoItemView.photoModel.havefeeback=YES;
//                [self.photoModels replaceObjectAtIndex:page withObject:photoItemView.photoModel];
//                
//            }else{
...
//            
//            
//            //[defaults setObject:@"yes" forKey:@"havelogin"];
//            
//        }];
//
//    }
   
   // mypimagev.image=[UIImage imageNamed:@"hellomeinv.jpeg"];
    
    [photoItemView.photoImageView setContentScaleFactor:[[UIScreen mainScreen] scale]];
    
     photoItemView.photoImageView.contentMode=UIViewContentModeScaleAspectFit;
    
     photoItemView.photoImageView.autoresizingMask = UIViewAutoresizingFlexibleHeight;
    
     photoItemView.photoImageView.clipsToBounds  = YES;
