...
-(void)confingSubViews{
    ...
    self.clickButton.layer.cornerRadius = 4.0;
    self.clickButton.layer.borderColor = [UIColor orangeColor].CGColor;
    ...
    [self.clickButton setTitleColor:[UIColor orangeColor] forState:UIControlStateNormal];
