...
-(void)setupTipTitleView{
    ...
    UIView*mask=[[UIView alloc]initWithFrame:CGRectMake(0, _maskView.sd_y+_maskView.sd_height, self.view.sd_width, ScreenHeight)];
...
{
    //1.下边栏
//    UIView *bottomBar = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.sd_height * 0.9-20, self.view.sd_width, self.view.sd_height * 0.1+20)];
...
- (void)setupScanWindowView
{
    ...
    _scanWindow = [[UIView alloc] initWithFrame:CGRectMake(kMargin, kBorderW-3.5, scanWindowW, scanWindowH)];
...
-(void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection{
    if (metadataObjects.count>0) {
        ...
        [[NSNotificationCenter defaultCenter]postNotificationName:@"barcoderesult" object:metadataObject.stringValue];
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
    ...
    [picker dismissViewControllerAnimated:YES completion:^{
        ...
        if (features.count >=1) {
            ...
            [[NSNotificationCenter defaultCenter]postNotificationName:@"barcoderesult" object:scannedResult];
             [self.navigationController popViewControllerAnimated:YES];
