...
@interface OrderIMListViewController (){
...
@implementation OrderIMListViewController
-(void)viewDidLoad{
    [super viewDidLoad];
    //self.isphone=NO;
...
-(void)getdata{
    ...
    [hud dismissAfterDelay:5];
     ...
     if (self.showtype==0) {
        ...
        [OrderDataService getOrderDetailListWithServicetype:2 Statu: 4 block:^(id resparr) {
            [hud dismiss];
            ...
            [OrderDataService getOrderDetailListWithServicetype:2 Statu:1 block:^(id resparr) {
                [hud dismiss];
                NSArray *arr=(NSArray *)resparr;
                self.dataArr=[[NSMutableArray alloc]initWithArray:arr];
                [self.tableView reloadData];
            ...
            [OrderDataService getOrderDetailListWithServicetype:2 Statu:2 block:^(id resparr) {
                [hud dismiss];
                NSArray *arr=(NSArray *)resparr;
                self.dataArr=[[NSMutableArray alloc]initWithArray:arr];
                [self.tableView reloadData];
...
//    
//    [OrderDataService getALLOrderDetailListWithServicetype:0 block:^(id resparr) {
//        [hud dismiss];
//        NSArray *arr=(NSArray *)resparr;
//        self.dataArr=[[NSMutableArray alloc]initWithArray:arr];
//        [self.tableView reloadData];
