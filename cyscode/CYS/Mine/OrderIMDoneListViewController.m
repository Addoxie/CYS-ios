//
//  OrderIMDoneListViewController.m
//  CYS
//
...
@interface OrderIMDoneListViewController (){
...
@implementation OrderIMDoneListViewController
-(void)viewDidLoad{
    [super viewDidLoad];
    //self.isphone=NO;
...
-(void)getdata{
    ...
    [OrderDataService getOrderDetailListWithServicetype:0 Statu:2 block:^(id resparr) {
        [hud dismiss];
