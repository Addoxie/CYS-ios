//
//  OrderIMCancleListViewController.m
//  CYS
//
...
@interface OrderIMCancleListViewController (){
...
@implementation OrderIMCancleListViewController
-(void)viewDidLoad{
    [super viewDidLoad];
    //self.isphone=NO;
...
-(void)getdata{
    ...
    [OrderDataService getOrderDetailListWithServicetype:0 Statu:4 block:^(id resparr) {
        [hud dismiss];
