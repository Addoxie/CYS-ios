...
@interface MsgListWebViewController ()
{
...
@implementation MsgListWebViewController
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType
{
    ...
    NSLog(@"%@",url);
    if([url rangeOfString:@"messageDetails.html"].location !=NSNotFound)//
    {
...
-(void)itemactionWithType:(NSInteger)typeindex{
    ...
    if (webview.canGoBack) {
        ...
        [self.delegate MsgListWebMethodname:@"" stringval:@"" type:1];
        [self.navigationController popViewControllerAnimated:YES];
    }
