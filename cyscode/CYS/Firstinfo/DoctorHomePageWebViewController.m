//
//  DoctorHomePageWebViewController.m
//  CYS
//
...
@interface DoctorHomePageWebViewController (){
...
@implementation DoctorHomePageWebViewController
-(void)viewDidLoad{
    [super viewDidLoad];
...
-(void)itemactionWithType:(NSInteger)typeindex{
    ...
    if (webview.canGoBack) {
       ...
       // [self.delegate MsgDetailMethodname:@"" stringval:@"" type:0];
        [self.navigationController popViewControllerAnimated:YES];
    }
