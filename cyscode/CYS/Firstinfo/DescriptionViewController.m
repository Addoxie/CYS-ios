...
-(void)morebuttonaction{
    NSString *resultstr=[webview stringByEvaluatingJavaScriptFromString:[NSString stringWithFormat:@"%@();",@"getIntro"]];
    [self.navigationController popViewControllerAnimated:YES];
    
    [self.delegate DescriptionDealtdataMethodname:self.methodname stringval:resultstr];
...
//        [self.navigationController popViewControllerAnimated:YES];
//        
//        [self.delegate DescriptionDealtdataMethodname:self.methodname stringval:[dic objectForKey:@"input"]];
//        
//    } else {
//        
//    }
