...
@interface HospitalWebViewController (){
...
@implementation HospitalWebViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
-(void)morebuttonaction{
    ...
    //
    //    }
    NSString *resultstr=[webview stringByEvaluatingJavaScriptFromString:[NSString stringWithFormat:@"%@();",@"userHospitalSelect"]];
...
//    NSLog(@"%@",dic);
    ...
    [self.delegate hospitalDealtdataMethodname:self.methodname stringval:resultstr];
//    if ([[dic objectForKey:@"state"] boolValue]==true) {
//        [self.navigationController popViewControllerAnimated:YES];
//        
//        [self.delegate hospitalDealtdataMethodname:self.methodname stringval:[dic objectForKey:@"input"]];
//        
//    } else {
//        
//    }
